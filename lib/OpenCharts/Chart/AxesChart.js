...
OpenCharts.Chart.AxesChart = OpenCharts.Class(OpenCharts.Chart,{
    ...
    addEventListener:function(action,message){
        ...
        */
        ...
        msgObj.setAttribute("id","axes_msg");
        msgObj.setAttribute("align","center");
        msgObj.style.background= fillcolor;
        msgObj.style.border="1px solid " + "#000";
        msgObj.style.position = "absolute";
        msgObj.style.opacity = 0.8;
        msgObj.style.left = "50%";
        msgObj.style.top = "50%";
        msgObj.style.font="12px/1.6em Verdana, Geneva, Arial, Helvetica, sans-serif";
        msgObj.style.marginLeft = "15px" ;
        msgObj.style.marginTop = "-25px" ;;
        //msgObj.style.width = 100 + "px";
        //msgObj.style.height =600 + "px";
    ...
    onMouseDown:function(evt){
        ...
        msgObj.style.background= fillcolor;
        msgObj.style.border="2px solid " + "#000";
        //msgObj.style.border="2px solid " + fillcolor;
        //msgObj.style.border-radius = "5px";
        //msgObj.innerHTML = me._message;
        msgObj.innerHTML =  me.itemArray[items[0].indexX][items[0].indexY].strCaption + me.itemArray[items[0].indexX][items[0].indexY].data;
        msgObj.style.left = items[0].positionX;
        msgObj.style.top = items[0].positionY;
