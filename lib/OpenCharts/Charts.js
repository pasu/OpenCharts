...
OpenCharts.Chart = OpenCharts.Class({
    ...
    /**
     * Property: bFixMaxValue
     * {Boolean} 是否固定图表数据中的最大值，用于时态图表
     */
    bFixMaxValue:false,
    ...
    /**
     * APIMethod: setFixMaxValue
     * 固定图表数据最大值。
     *
     * Parameters:
     * value - {Number)} 图表数据数组。
     */
    setFixMaxValue:function(value){
        var me = this;
        this.maxValue = value;
        this.bFixMaxValue = true;
    },

    /**
     * APIMethod: isFixMaxValue
     * 获取是否固定图表数据最大值。
     */
    isFixMaxValue:function(){
        return this.bFixMaxValue;
    },
